...
open class DatePickerDialog: UIView {
    ...
    private func createContainerView() -> UIView {
        ...
        var colorArray = [UIColor(hexString: "#FE826A", withAlpha: 1),
                          UIColor(hexString: "#93CCC8", withAlpha: 1),
                          UIColor(hexString: "#43A6F0", withAlpha: 1)]
        dialogContainer.backgroundColor = colorArray[globalGradientIndex/2]//colorArray[globalGradientIndex/2] as! CGColor
        ...
        dialogContainer.layer.borderColor = colorArray[globalGradientIndex/2]?.cgColor
        dialogContainer.layer.borderWidth = 1
        dialogContainer.layer.shadowRadius = cornerRadius + 10
        dialogContainer.layer.shadowOpacity = 0.15
        ...
        lineView.backgroundColor = colorArray[globalGradientIndex/2]
