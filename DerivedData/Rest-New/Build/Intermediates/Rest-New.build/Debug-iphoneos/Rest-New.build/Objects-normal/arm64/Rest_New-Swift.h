...
SWIFT_CLASS("_TtC8Rest_New19AlarmViewController")
...
SWIFT_CLASS("_TtC8Rest_New28AlertChildPageViewController")
@interface AlertChildPageViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified image;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified labelMainTitle;
...
SWIFT_CLASS("_TtC8Rest_New15AlertOnboarding")
...
SWIFT_CLASS("_TtC8Rest_New23AlertPageViewController")
@interface AlertPageViewController : UIViewController <UIPageViewControllerDataSource, UIPageViewControllerDelegate>
@property (nonatomic, strong) UIPageViewController * _Null_unspecified pageController;
@property (nonatomic, strong) UIPageControl * _Null_unspecified pageControl;
@property (nonatomic, strong) AlertOnboarding * _Null_unspecified alertview;
@property (nonatomic, copy) NSArray<NSString *> * _Null_unspecified arrayOfImage;
@property (nonatomic, copy) NSArray<NSString *> * _Null_unspecified arrayOfTitle;
@property (nonatomic, copy) NSArray<NSString *> * _Null_unspecified arrayOfDescription;
...
- (nonnull instancetype)initWithArrayOfImage:(NSArray<NSString *> * _Nonnull)arrayOfImage arrayOfTitle:(NSArray<NSString *> * _Nonnull)arrayOfTitle arrayOfDescription:(NSArray<NSString *> * _Nonnull)arrayOfDescription alertView:(AlertOnboarding * _Nonnull)alertView OBJC_DESIGNATED_INITIALIZER;
...
- (UIViewController * _Nullable)viewControllerAtIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
...
- (void)configureConstraintsForPageControl;
...
SWIFT_CLASS("_TtC8Rest_New11AppDelegate")
...
SWIFT_CLASS("_TtC8Rest_New16DatePickerDialog")
...
- (CGSize)countScreenSize SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC8Rest_New18DraggableImageView")
...
SWIFT_CLASS("_TtC8Rest_New13FadeImageView")
...
SWIFT_CLASS("_TtC8Rest_New19ScrollableGraphView")
...
SWIFT_CLASS("_TtC8Rest_New14SleepChartView")
@interface SleepChartView : UIViewController <iCarouselDelegate, iCarouselDataSource>
...
@property (nonatomic, weak) IBOutlet iCarousel * _Null_unspecified carousel;
...
SWIFT_CLASS("_TtC8Rest_New9StatLabel")
@interface StatLabel : UIView
...
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (UIView * _Nonnull)loadViewFromNib SWIFT_WARN_UNUSED_RESULT;
@end


@interface UIColor (SWIFT_EXTENSION(Rest_New))
+ (UIColor * _Nonnull)colorFromHexWithHexString:(NSString * _Nonnull)hexString SWIFT_WARN_UNUSED_RESULT;
@end


@interface UIWindow (SWIFT_EXTENSION(Rest_New))
...
@interface NSUserDefaults (SWIFT_EXTENSION(Rest_New))
+ (BOOL)isFirstLaunch SWIFT_WARN_UNUSED_RESULT;
@end

@class CAGradientLayer;

SWIFT_CLASS("_TtC8Rest_New14ViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified AMPMLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified invisAlarm;
...
@property (nonatomic, copy) NSArray<CGColorRef> * _Nonnull gradientArray;
@property (nonatomic, copy) NSArray<CGColorRef> * _Nonnull currDayGradient;
@property (nonatomic, copy) NSDate * _Nonnull DatePickerDate;
@property (nonatomic, strong) AlertOnboarding * _Null_unspecified alertView;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull arrayOfImage;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull arrayOfTitle;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull arrayOfDescription;
- (void)viewDidLoad;
- (IBAction)showTutorial:(id _Nonnull)sender;
...
- (void)dateToStringWithDate:(NSDate * _Nonnull)date;
- (void)invisPressed;
